...
public class C05_CheckBox {
    ...
    // c. Checkbox1 seçili değilse onay kutusunu tıklayın ve secili oldgunu test edin
    // d. Checkbox2 seçili değilse onay kutusunu tıklayın ve secili oldgunu test edin
